...
% 
% USE: [UTC_time, leap_sec, day_of_year]=gps2utc([1667 259200], 0)
%
% Input:   
%   GPS_time - GPS time (nx2) [GPS_week GPS_sec] 
%               valid GPS_week values are 1-3640 (years 1980-2050) GPS week
%               values are kept in linear time without the 1024 rollovers 
...
% Check to see if the leap second offset causes a negative number of
% minutes 
